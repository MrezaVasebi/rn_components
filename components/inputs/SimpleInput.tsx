...
const SimpleInput = (props: ISimpleInput) => {
   ...
   return <TextInput placeholderTextColor={appColors.grey} placeholder={placeholder} {...rest} value={value} onChangeText={onChangeText} style={{ ...styles.inputStyle, ...inputStyle }} />;
};
