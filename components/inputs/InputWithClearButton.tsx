...
const InputWithClearButton = (props: IInputWithClearButton) => {
   let { value, placeholder, onChangeText, label, showLabel, root, onPressClear } = props;
   ...
   return (
      <View style={{ ...styles.root, ...root }}>
         ...
         <View style={{ ...styles.inputContainer }}>
            <TouchableOpacity activeOpacity={0.5} onPress={onPressClear} style={styles.clearStyle}>
